...
function cssmin() {
  ...
  .pipe(cleanCSS())
  .pipe(dest('dist/source-files/hintio-css-min-files/'))
}
...
function cssexp() {
  ...
  .pipe(dest('dist/source-files/hintio-css-files/'))
}
...
function libs() {
  return src([
    ...
    'assets/jquery.mCustomScrollbar.js',
...
function libsexp() {
  ...
  .pipe(concat('libs.js'))
  .pipe(dest('dist/source-files/hintio-js-files/'))
}
